...
const normalizeBrokerProposal = (row, office) => ({
  ...
  brokerUserId: office?.brokerUserId || row.broker_user_id || null,
  brokerKey: office?.brokerUserId || row.broker_user_id || row.broker_office_id,
  brokerName: office?.agentName || row.broker_name || "중개사",
